// Mirror of the React binding in `../react/useTree.ts`. Preact is a
// separate file rather than a `preact/compat` alias because
// `castkit/packages/slatecast` has 60 KB gz to spend and compat is
// most of that budget.
