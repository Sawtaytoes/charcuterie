...
- f945328: `useFlipList` can key off an attribute the markup already carries
...
- 966d328: `useFlipList` — a re-ordered list animates from where it was, instead of cutting
