...
> **modernized** plex-channels / image-viewer / gallery-downloader, then lounge-tv.
...
| lounge-tv | three vanilla PWAs + one Python project | no |
...
Tailwind so they can consume the library; **leave lounge-tv alone** — "it's doing its own thing.
...
lounge-tv is out of M6 entirely and is not a blocker for the 1.0.0 cut.
