...
is **the end of M6** — after `lounge-tv`, the last name in M6's fleet list.
...
| | Ships |
| --- | --- |
| **M6** | P1 breadth (Select, Menu, Tooltip, Toast, Accordion, Field, LogViewer, SortableTableHeader, FileDropZone) **+ the rest of the fleet**: mux-magic, then plex-channels / image-viewer / gallery-downloader, **then lounge-tv**. |
